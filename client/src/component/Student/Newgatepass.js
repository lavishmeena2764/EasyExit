...
const Newgatepass = () => {
  ...
  return (
    <div>
      <header className="navbar" style={{boxShadow: "0 5px 10px rgba(0,0,0,0.2)"}}>
        <div className="logo">
          <h3>
            Easy<span style={{ color: '#8968FF' }}>Exit</span>
          </h3>
        </div>
        <div className="profile-icon" style={{justifyContent:"right", padding:"10px", display:"flex", gap:"35px"}}><a href='/login'>Logout</a><a href='/login'><img src='person.png' /></a></div>
      </header>
